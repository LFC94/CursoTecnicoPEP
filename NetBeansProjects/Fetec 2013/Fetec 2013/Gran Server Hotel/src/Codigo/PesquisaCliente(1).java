...
public class PesquisaCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cadastrarhospedeQuery = java.beans.Beans.isDesignTime() ? null : entityManager0.createQuery("SELECT c FROM Cadastrarhospede c");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cadastrarhospedeQuery=entityManager0.createQuery("SELECT c FROM Cadastrarhospede c WHERE c.nome='"+PesquisaTextField.getText()+"'");
